...
export default function Ubatuba() {
  ...
  return (
    <CityPage
      ...
      attractions={[
        { name: "Ruínas da Lagoinha", image: require("../../../../assets/images/ruinauba.png"), onPress: () => navTo("RuinasLagoinha") },
        { name: "Praia do Português", image: require("../../../../assets/images/portuuba.png"), onPress: () => navTo("PraiaPortugues") },
        { name: "Ilha das Couves", image: require("../../../../assets/images/couveuba.png"), onPress: () => navTo("IlhaDasCouves") },
        { name: "Cachoeira do Prumirim", image: require("../../../../assets/images/cachouba.png"), onPress: () => navTo("CachoeiraPrumirim") },
      ]}
      foods={[
        { name: "Moqueca Caiçara", desc: "Versão local da moqueca, usando peixe fresco, dendê, leite de coco e ervas regionais.", image: require("../../../../assets/images/moqueca.png"), onPress: () => navTo("Moqueca") },
        { name: "Lambe-Lambe", desc: "Arroz preparado com mexilhões, tradição local ligada à maricultura.", image: require("../../../../assets/images/lambe.png"), onPress: () => navTo("LambeLambe") },
      ]}
      events={[
